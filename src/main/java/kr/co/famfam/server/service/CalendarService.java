...
public interface CalendarService {
    ...
    DefaultRes addSchedule(final int calendarType, final CalendarReq calendarReq);
    DefaultRes updateSchedule(final int calendarType, final int calendarIdx, final CalendarReq calendarReq);
    DefaultRes deleteSchedule(final int calendarType, final int calendarIdx, final CalendarReq calendarReq);
}
